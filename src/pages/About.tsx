    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        <div className="luxury-container py-16">
          <h1 className="section-title mb-8">About VishalNexus</h1>
          ...
          <div className="prose max-w-none">
            ...
            <div className="my-12 grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-luxury-silver p-8 rounded-lg">
                <h3 className="font-serif text-2xl text-luxury-navy mb-4">Our Mission</h3>
                <p>
              ...
              <div className="bg-luxury-silver p-8 rounded-lg">
                <h3 className="font-serif text-2xl text-luxury-navy mb-4">Our Vision</h3>
                <p>
