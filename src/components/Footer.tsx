    ...
    <footer className="bg-luxury-charcoal text-white">
      <div className="luxury-container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="flex flex-col items-start">
              <span className="font-serif text-2xl font-bold text-white">VishalNexus</span>
              <span className="text-xs uppercase tracking-widest text-luxury-gold">Refined Homes</span>
            </Link>
            <p className="mt-4 text-gray-400">
              Exceptional properties for the discerning buyer. Luxury living redefined.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/buy" className="text-gray-400 hover:text-white transition-colors">Buy</Link></li>
              <li><Link to="/rent" className="text-gray-400 hover:text-white transition-colors">Rent</Link></li>
              <li><Link to="/contact" className="text-gray-400 hover:text-white transition-colors">Contact</Link></li>
            </ul>
          </div>
          
          <div>
            <h3 className="text-lg font-serif font-medium mb-4">Locations</h3>
            <ul className="space-y-2">
          ...
          <div>
            ...
            <address className="not-italic">
              <p className="text-gray-400">1234 Luxury Avenue</p>
              <p className="text-gray-400">Beverly Hills, CA 90210</p>
              <p className="text-gray-400 mt-2">info@vishalnexus.com</p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
          <p>© {new Date().getFullYear()} VishalNexus. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
