                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="col-span-1 md:col-span-1">
                        <Link to="/" className="flex flex-col items-start">
                            ...
                            <span className="text-xs uppercase tracking-widest brand-subtitle-text">Refined Homes</span>
                        </Link>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link to="/buy" className="nav-link-item">Buy</Link></li>
                            <li><Link to="/rent" className="nav-link-item">Rent</Link></li>
